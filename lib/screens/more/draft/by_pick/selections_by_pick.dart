...
class DraftSelectionsByPick extends StatefulWidget {
  final List<dynamic> selections;

  const DraftSelectionsByPick({
    super.key,
    required this.selections,
  });

  @override
  State<DraftSelectionsByPick> createState() => _DraftSelectionsByPickState();
}

class _DraftSelectionsByPickState extends State<DraftSelectionsByPick> {
  List columnNames = [
    'YEAR',
    'TEAM',
    'PLAYER',
