...
class WildcardStandings extends StatefulWidget {
  ...
  @override
  State<WildcardStandings> createState() => _WildcardStandingsState();
}

class _WildcardStandingsState extends State<WildcardStandings> {
  ...
  Widget getContent(List eastTeams, int row, int column, BuildContext context) {
    switch (column) {
          ...
          child: Row(
            children: [
              Expanded(
                flex: 1,
                child: Text(
                  teams[row]['istWildcardRank'].toString(),
      ...
      case 4:
        String gb = (teams[row]['istWildcardGb'] ?? 0.0).toString();
