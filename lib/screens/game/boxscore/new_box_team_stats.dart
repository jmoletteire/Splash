...
class NewBoxTeamStats extends StatefulWidget {
  final List<dynamic> teams;
  final String homeId;
  final String awayId;
  const NewBoxTeamStats({
    super.key,
    required this.teams,
  ...
  @override
  State<NewBoxTeamStats> createState() => _NewBoxTeamStatsState();
}

class _NewBoxTeamStatsState extends State<NewBoxTeamStats> {
  dynamic homeTeam = {};
  dynamic awayTeam = {};
  ...
  void setValues(String homeId, String awayId) {
    setState(() {
      homeTeam = widget.teams[1];
      awayTeam = widget.teams[0];
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    ComparisonRow(
                      statName: 'DEF RATING',
                      awayTeam: awayTeam['DEF_RATING'] ?? 0.0,
                      homeTeam: homeTeam['DEF_RATING'] ?? 0.0,
                      awayTeamColor: awayTeamColor,
                      homeTeamColor: homeTeamColor,
                    ),
                    const SizedBox(height: 5.0),
                    ComparisonRow(
                      statName: 'NET RATING',
                      awayTeam: awayTeam['NET_RATING'] ?? 0.0,
                      homeTeam: homeTeam['NET_RATING'] ?? 0.0,
                      awayTeamColor: awayTeamColor,
                      homeTeamColor: homeTeamColor,
                    ),
                    const SizedBox(height: 15.0),
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [Text('Shooting', style: kBebasBold.copyWith(fontSize: 20.0))],
                    ),
                    const SizedBox(height: 15.0),
                    NonComparisonRow(
                      statName: 'FG',
                    ...
                    ComparisonRow(
                      statName: 'FG%',
                      awayTeam: roundToDecimalPlaces((awayTeam['FG_PCT'] ?? 0.0) * 100, 1),
                      homeTeam: roundToDecimalPlaces((homeTeam['FG_PCT'] ?? 0.0) * 100, 1),
                      awayTeamColor: awayTeamColor,
                      homeTeamColor: homeTeamColor,
                    ),
                    const SizedBox(height: 15.0),
                    ...
                    ComparisonRow(
                      statName: '3P%',
                      awayTeam: roundToDecimalPlaces((awayTeam['FG3_PCT'] ?? 0.0) * 100, 1),
                      homeTeam: roundToDecimalPlaces((homeTeam['FG3_PCT'] ?? 0.0) * 100, 1),
                      awayTeamColor: awayTeamColor,
                      homeTeamColor: homeTeamColor,
                    ),
                    const SizedBox(height: 15.0),
                    ...
                    ComparisonRow(
                      statName: 'FT%',
                      awayTeam: roundToDecimalPlaces((awayTeam['FT_PCT'] ?? 0.0) * 100, 1),
                      homeTeam: roundToDecimalPlaces((homeTeam['FT_PCT'] ?? 0.0) * 100, 1),
                      awayTeamColor: awayTeamColor,
                      homeTeamColor: homeTeamColor,
                    ),
                    const SizedBox(height: 15.0),
                    ComparisonRow(
                      statName: 'EFG%',
                      awayTeam: roundToDecimalPlaces((awayTeam['EFG_PCT'] ?? 0.0) * 100, 1),
                      homeTeam: roundToDecimalPlaces((homeTeam['EFG_PCT'] ?? 0.0) * 100, 1),
                      awayTeamColor: awayTeamColor,
                      homeTeamColor: homeTeamColor,
                    ),
                    const SizedBox(height: 5.0),
                    ComparisonRow(
                      statName: 'TS%',
                      awayTeam: roundToDecimalPlaces((awayTeam['TS_PCT'] ?? 0.0) * 100, 1),
                      homeTeam: roundToDecimalPlaces((homeTeam['TS_PCT'] ?? 0.0) * 100, 1),
                      awayTeamColor: awayTeamColor,
                      homeTeamColor: homeTeamColor,
                    ),
                  ],
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    ComparisonRow(
                      statName: 'OREB%',
                      awayTeam: roundToDecimalPlaces((awayTeam['OREB_PCT'] ?? 0.0) * 100, 1),
                      homeTeam: roundToDecimalPlaces((homeTeam['OREB_PCT'] ?? 0.0) * 100, 1),
                      awayTeamColor: awayTeamColor,
                      homeTeamColor: homeTeamColor,
                    ),
                    const SizedBox(height: 5.0),
                    ComparisonRow(
                      statName: 'DREB%',
                      awayTeam: roundToDecimalPlaces((awayTeam['DREB_PCT'] ?? 0.0) * 100, 1),
                      homeTeam: roundToDecimalPlaces((homeTeam['DREB_PCT'] ?? 0.0) * 100, 1),
                      awayTeamColor: awayTeamColor,
                      homeTeamColor: homeTeamColor,
                    ),
                  ],
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [Text('Passing', style: kBebasBold.copyWith(fontSize: 20.0))],
                    ),
                    const SizedBox(height: 15.0),
                    ComparisonRow(
                      statName: 'AST',
                    ...
                    ComparisonRow(
                      statName: 'AST%',
                      awayTeam: roundToDecimalPlaces((awayTeam['AST_PCT'] ?? 0) * 100, 1),
                      homeTeam: roundToDecimalPlaces((homeTeam['AST_PCT'] ?? 0) * 100, 1),
                      awayTeamColor: awayTeamColor,
                      homeTeamColor: homeTeamColor,
                    ),
                    const SizedBox(height: 5.0),
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [Text('Defense', style: kBebasBold.copyWith(fontSize: 20.0))],
                    ),
                    const SizedBox(height: 15.0),
                    ComparisonRow(
                      statName: 'STL',
...
class ComparisonRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    bool oneIsBetter =
        (statName.contains('DRTG') || statName == 'PF' || statName.contains('TOV'))
            ? awayTeam < homeTeam
            : awayTeam > homeTeam;
    bool twoIsBetter =
        (statName.contains('DRTG') || statName == 'PF' || statName.contains('TOV'))
