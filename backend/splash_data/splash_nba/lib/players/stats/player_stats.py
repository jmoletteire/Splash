...
def update_player_stats(season_type, team_id):
    ...
    if season_type == 'REGULAR SEASON':
        basic_stats = leaguedashplayerstats.LeagueDashPlayerStats(proxy=PROXY, headers=HEADERS, season=CURR_SEASON, team_id_nullable=team_id).get_normalized_dict()['LeagueDashPlayerStats']
        adv_stats = leaguedashplayerstats.LeagueDashPlayerStats(proxy=PROXY, headers=HEADERS, measure_type_detailed_defense='Advanced', season=CURR_SEASON, team_id_nullable=team_id).get_normalized_dict()['LeagueDashPlayerStats']
    elif season_type == 'PLAYOFFS':
        basic_stats = leaguedashplayerstats.LeagueDashPlayerStats(proxy=PROXY, headers=HEADERS, season=CURR_SEASON, season_type_all_star='Playoffs', team_id_nullable=team_id).get_normalized_dict()['LeagueDashPlayerStats']
        adv_stats = leaguedashplayerstats.LeagueDashPlayerStats(proxy=PROXY, headers=HEADERS, measure_type_detailed_defense='Advanced', season=CURR_SEASON, season_type_all_star='Playoffs', team_id_nullable=team_id).get_normalized_dict()['LeagueDashPlayerStats']
...
def fetch_playoff_stats(seasons):
    for season in seasons:
        basic_stats = leaguedashplayerstats.LeagueDashPlayerStats(proxy=PROXY, headers=HEADERS, season=season, season_type_all_star='Playoffs').get_normalized_dict()['LeagueDashPlayerStats']
        adv_stats = leaguedashplayerstats.LeagueDashPlayerStats(proxy=PROXY, headers=HEADERS, measure_type_detailed_defense='Advanced', season=season, season_type_all_star='Playoffs').get_normalized_dict()['LeagueDashPlayerStats']
...
def fetch_player_stats(seasons):
    for season in seasons:
        # Fetch basic and advanced stats for the given season
        basic_stats = leaguedashplayerstats.LeagueDashPlayerStats(proxy=PROXY, headers=HEADERS, season=season).get_normalized_dict()['LeagueDashPlayerStats']
        adv_stats = leaguedashplayerstats.LeagueDashPlayerStats(proxy=PROXY, headers=HEADERS, measure_type_detailed_defense='Advanced', season=season).get_normalized_dict()['LeagueDashPlayerStats']
