...
custom_stats = [
    ...
    # ADV -> DRIVES
    ("DRIVES", "REGULAR SEASON.ADV.DRIVES", -1),
    ("DRIVE_FGM", "REGULAR SEASON.ADV.DRIVES", -1),
    ("DRIVE_FGA", "REGULAR SEASON.ADV.DRIVES", -1),
    ("DRIVE_FG_PCT", "REGULAR SEASON.ADV.DRIVES", -1),
    ("DRIVE_FTM", "REGULAR SEASON.ADV.DRIVES", -1),
    ("DRIVE_FTA", "REGULAR SEASON.ADV.DRIVES", -1),
    ("DRIVE_FT_PCT", "REGULAR SEASON.ADV.DRIVES", -1),
    ("DRIVE_PTS", "REGULAR SEASON.ADV.DRIVES", -1),
    ("DRIVE_PTS_PCT", "REGULAR SEASON.ADV.DRIVES", -1),
    ("DRIVE_PASSES", "REGULAR SEASON.ADV.DRIVES", -1),
    ("DRIVE_PASSES_PCT", "REGULAR SEASON.ADV.DRIVES", -1),
    ("DRIVE_AST", "REGULAR SEASON.ADV.DRIVES", -1),
    ("DRIVE_AST_PCT", "REGULAR SEASON.ADV.DRIVES", -1),
    ("DRIVE_TOV", "REGULAR SEASON.ADV.DRIVES", 1),
    ("DRIVE_TOV_PCT", "REGULAR SEASON.ADV.DRIVES", 1),

    ("DRIVES_PER_75", "REGULAR SEASON.ADV.DRIVES", -1),
    ("DRIVE_FGM_PER_75", "REGULAR SEASON.ADV.DRIVES", -1),
    ("DRIVE_FGA_PER_75", "REGULAR SEASON.ADV.DRIVES", -1),
    ("DRIVE_FTM_PER_75", "REGULAR SEASON.ADV.DRIVES", -1),
    ("DRIVE_FTA_PER_75", "REGULAR SEASON.ADV.DRIVES", -1),
    ("DRIVE_PTS_PER_75", "REGULAR SEASON.ADV.DRIVES", -1),
    ("DRIVE_PASSES_PER_75", "REGULAR SEASON.ADV.DRIVES", -1),
    ("DRIVE_AST_PER_75", "REGULAR SEASON.ADV.DRIVES", -1),
    ("DRIVE_TOV_PER_75", "REGULAR SEASON.ADV.DRIVES", 1),

    # ADV -> REBOUNDING
    ("OREB_CONTEST", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("OREB_UNCONTEST", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("OREB_CONTEST_PCT", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("OREB_CHANCES", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("OREB_CHANCE_DEFER", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("OREB_CHANCE_PCT", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("OREB_CHANCE_PCT_ADJ", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("DREB_CONTEST", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("DREB_UNCONTEST", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("DREB_CONTEST_PCT", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("DREB_CHANCES", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("DREB_CHANCE_DEFER", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("DREB_CHANCE_PCT", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("DREB_CHANCE_PCT_ADJ", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("REB_CONTEST", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("REB_UNCONTEST", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("REB_CONTEST_PCT", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("REB_CHANCES", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("REB_CHANCE_DEFER", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("REB_CHANCE_PCT", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("REB_CHANCE_PCT_ADJ", "REGULAR SEASON.ADV.REBOUNDING", -1),

    ("OREB_CONTEST_PER_75", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("OREB_UNCONTEST_PER_75", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("OREB_CHANCES_PER_75", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("OREB_CHANCE_DEFER_PER_75", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("DREB_CONTEST_PER_75", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("DREB_UNCONTEST_PER_75", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("DREB_CHANCES_PER_75", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("DREB_CHANCE_DEFER_PER_75", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("REB_CONTEST_PER_75", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("REB_UNCONTEST_PER_75", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("REB_CHANCES_PER_75", "REGULAR SEASON.ADV.REBOUNDING", -1),
    ("REB_CHANCE_DEFER_PER_75", "REGULAR SEASON.ADV.REBOUNDING", -1)
]
